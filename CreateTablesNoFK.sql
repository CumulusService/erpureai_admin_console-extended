-- AdminConsole Database Schema (No Foreign Keys)
...
-- Onboarded Users Table (No Foreign Key)
...
-- User Database Assignments Table (No Foreign Keys)
...
VALUES (N'20250803215902_InitialCreate', N'9.0.0');
